...
import { EntityType, Exact, GlossaryTerm } from '../../../../types.generated';
...
export type Props = {
    ...
    glossaryRelatedTermResult: Array<GlossaryTerm>;
};
...
export default function GlossaryRelatedTermsResult({ glossaryRelatedTermType, glossaryRelatedTermResult }: Props) {
    ...
    glossaryRelatedTermResult.forEach((item: GlossaryTerm) => {
        glossaryRelatedTermUrns.push(item.urn);
    });
