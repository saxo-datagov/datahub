...
import { GlossaryRelatedTerms } from '../../../../types.generated';
...
export default function GlossayRelatedTerms({ glossaryRelatedTerms }: Props) {
            ...
            <Content>
                {selectedKey && (
                    <GlossaryRelatedTermsResult
                        ...
                        glossaryRelatedTermResult={glossaryRelatedTerms[selectedKey] || []}
                    />
                )}
            </Content>
        </DetailWrapper>
